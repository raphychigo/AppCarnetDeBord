...
/**
 * Servlet implementation class AjoutMotifServlet
 */
@WebServlet("/Login/Administrateur/AjoutMotif")
public class AjoutMotifServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjoutMotifServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		try {
			DAOMotif.insert(new Motif(request.getParameter("motif")));
