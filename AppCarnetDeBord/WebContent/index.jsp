	...
	<%@ include file="/element/accueil.jsp" %>
			<div class="row">	
				...
				<div class="col-sm-10 ecran-modification">
						<div class="titre">ERP - Gestion de park véhicule</div>
						<p class="introduction">Créée en 1981, 
						ENI Ecole Informatique a acquis une renommée nationale dans la formation d'informaticiens.</br> 
					...
					mais aussi et surtout l'emploi. </br>L'école est agréée par les éditeurs
